...
constexpr unsigned I_ISA_EXT = csr_misa::I;
...
constexpr unsigned S_ISA_EXT = csr_misa::S;
constexpr unsigned U_ISA_EXT = csr_misa::U;
constexpr unsigned N_ISA_EXT = csr_misa::N;
